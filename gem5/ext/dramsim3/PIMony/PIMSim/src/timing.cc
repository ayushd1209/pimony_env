...
Timing::Timing(const Config &config)
    : same_bank(static_cast<int>(CommandType::SIZE)),
      other_subarrays_same_bank(static_cast<int>(CommandType::SIZE)),
    ...
    int read_to_write =
        config.RL + config.burst_cycle - config.WL + config.tRTRS;
    ...
    int gb_io_latency = config.tWTR_L - config.tWTR_S;
    ...
    int read_to_pim_read_same_bk = read_to_read_l + gb_io_latency;
    int write_to_pim_read_same_bk = write_to_read_l;

    // other banks in same bankgroup
    int read_to_pim_read_same_bg = read_to_read_l + gb_io_latency;
    ...
    int mac_to_readres = 6 * read_to_read_l;  // MAC pipeline draining
    ...
    same_bank[static_cast<int>(CommandType::READ)] =
        std::vector<std::pair<CommandType, int>>{
            ...
            {CommandType::D2GWRITE, read_to_read_l},
            {CommandType::H2GWRITE, read_to_write},
            {CommandType::COMP, read_to_pim_read_same_bk},
            {CommandType::MAC, read_to_pim_read_same_bk},
            {CommandType::READRES, read_to_pim_read_same_bk},
            {CommandType::PWRITE, read_to_write},
        };

    other_subarrays_same_bank[static_cast<int>(CommandType::READ)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_l},
            {CommandType::WRITE, read_to_write},
            {CommandType::READ_PRECHARGE, read_to_read_l},
    ...
    other_banks_same_bankgroup[static_cast<int>(CommandType::READ)] =
        std::vector<std::pair<CommandType, int>>{
            ...
            {CommandType::MAC, read_to_pim_read_same_bg},
    ...
    other_bankgroups_same_rank[static_cast<int>(CommandType::READ)] =
        std::vector<std::pair<CommandType, int>>{
            ...
            {CommandType::MAC, read_to_read_s},
    ...
    same_bank[static_cast<int>(CommandType::WRITE)] =
        std::vector<std::pair<CommandType, int>>{
            ...
            {CommandType::D2GWRITE, write_to_read_l},
            {CommandType::H2GWRITE, write_to_read_s},
            {CommandType::PWRITE, write_to_write_l},
            {CommandType::COMP, write_to_pim_read_same_bk},
            {CommandType::MAC, write_to_pim_read_same_bk},
            {CommandType::READRES, write_to_pim_read_same_bk},
        };

    other_subarrays_same_bank[static_cast<int>(CommandType::WRITE)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, write_to_read_l},
            {CommandType::WRITE, write_to_write_l},
            {CommandType::READ_PRECHARGE, write_to_read_l},
    ...
    other_banks_same_bankgroup[static_cast<int>(CommandType::WRITE)] =
        std::vector<std::pair<CommandType, int>>{
            ...
            {CommandType::MAC, write_to_pim_read_same_bg},
    ...
    other_bankgroups_same_rank[static_cast<int>(CommandType::WRITE)] =
        std::vector<std::pair<CommandType, int>>{
            ...
            {CommandType::D2GWRITE, write_to_read_s},
            {CommandType::H2GWRITE, write_to_read_s},
            {CommandType::COMP, write_to_read_s},
            {CommandType::MAC, write_to_read_s},
    ...
    same_bank[static_cast<int>(CommandType::ACTIVATE)] =
        std::vector<std::pair<CommandType, int>>{
            ...
            {CommandType::MAC, activate_to_read},
            {CommandType::D2GWRITE, activate_to_read}};

    other_subarrays_same_bank[static_cast<int>(CommandType::ACTIVATE)] =
        std::vector<std::pair<CommandType, int>>{
    ...
    other_subarrays_same_bank[static_cast<int>(CommandType::PRECHARGE)] =
        std::vector<std::pair<CommandType, int>>{
            // {CommandType::ACTIVATE, precharge_to_activate},
            {CommandType::REFRESH, precharge_to_activate},
            {CommandType::REFRESH_BANK, precharge_to_activate},
    ...
    same_rank[static_cast<int>(CommandType::REFRESH)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::ACTIVATE, refresh_to_activate},
            {CommandType::READRES, refresh_to_activate},
            {CommandType::MAC, refresh_to_activate},
    ...
    same_bank[static_cast<int>(CommandType::D2GWRITE)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, gwrite_latency},
            {CommandType::WRITE, gwrite_latency},
            {CommandType::H2GWRITE, gwrite_latency},
            {CommandType::PRECHARGE, gwrite_latency},
            {CommandType::COMP, gwrite_latency},
            {CommandType::MAC, gwrite_latency},
        };

    other_subarrays_same_bank[static_cast<int>(CommandType::D2GWRITE)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, gwrite_latency},
            {CommandType::WRITE, gwrite_latency},
            {CommandType::H2GWRITE, gwrite_latency},
    ...
    other_banks_same_bankgroup[static_cast<int>(CommandType::D2GWRITE)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_l},
            {CommandType::WRITE, read_to_write},
            {CommandType::D2GWRITE, gwrite_latency},
            {CommandType::H2GWRITE, gwrite_latency},
            {CommandType::COMP, gwrite_latency},
            {CommandType::MAC, gwrite_latency},
            {CommandType::READRES, gwrite_latency},
        };
    other_bankgroups_same_rank[static_cast<int>(CommandType::D2GWRITE)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_s},
            {CommandType::WRITE, read_to_write},
            {CommandType::D2GWRITE, gwrite_latency},
    ...
    same_rank[static_cast<int>(CommandType::H2GWRITE)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, gwrite_latency},
            {CommandType::WRITE, gwrite_latency},
            {CommandType::D2GWRITE, gwrite_latency},
    ...
    other_ranks[static_cast<int>(CommandType::H2GWRITE)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, gwrite_latency},
            {CommandType::WRITE, gwrite_latency},
            {CommandType::D2GWRITE, gwrite_latency},
    ...
    other_subarrays_same_bank[static_cast<int>(CommandType::COMP)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_l},
            {CommandType::WRITE, read_to_write},
            {CommandType::D2GWRITE, read_to_read_l},
            {CommandType::H2GWRITE, read_to_read_s},
            {CommandType::COMP, read_to_read_l},
            {CommandType::MAC, read_to_read_l},
            {CommandType::READRES, mac_to_readres},
        };

    same_rank[static_cast<int>(CommandType::COMP)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_l},
            {CommandType::WRITE, read_to_write},
            {CommandType::D2GWRITE, read_to_read_s},
            {CommandType::H2GWRITE, read_to_read_s},
            {CommandType::COMP, read_to_read_l},
            {CommandType::READRES, mac_to_readres},
    ...
    //  command MAC
    same_bank[static_cast<int>(CommandType::MAC)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_l},
            {CommandType::WRITE, read_to_write},
            {CommandType::READ_PRECHARGE, read_to_read_l},
            {CommandType::WRITE_PRECHARGE, read_to_write},
            {CommandType::D2GWRITE, read_to_read_l},
            {CommandType::H2GWRITE, read_to_read_l},
            {CommandType::READRES, mac_to_readres},
        };

    other_bankgroups_same_rank[static_cast<int>(CommandType::MAC)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_s},
            {CommandType::WRITE, read_to_write},
            {CommandType::READ_PRECHARGE, read_to_read_s},
    ...
    other_subarrays_same_bank[static_cast<int>(CommandType::MAC)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_l},
            {CommandType::WRITE, read_to_write},
            {CommandType::D2GWRITE, read_to_read_l},
            {CommandType::H2GWRITE, read_to_read_s},
            {CommandType::MAC, read_to_read_l},
            {CommandType::MACINTR, read_to_read_l},
            {CommandType::READRES, mac_to_readres},
        };

    same_rank[static_cast<int>(CommandType::MAC)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_s},
            {CommandType::WRITE, read_to_write},
            {CommandType::D2GWRITE, read_to_read_s},
    ...
    same_rank[static_cast<int>(CommandType::READRES)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_s},
            {CommandType::WRITE, read_to_write},
            {CommandType::D2GWRITE, read_to_read_s},
    ...
    other_ranks[static_cast<int>(CommandType::READRES)] =
        std::vector<std::pair<CommandType, int>>{
            {CommandType::READ, read_to_read_o},
            {CommandType::WRITE, read_to_write_o},
        };
