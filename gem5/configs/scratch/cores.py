...
# NOTE: obtain_resource("riscv-matrix-multiply-run") is broken on gem5 23.0
# (the MongoDB Atlas resource API it uses was retired -> HTTP 410). For now we
# run a local RISC-V binary instead. Swap this path for any RISC-V ELF you build.
binary = BinaryResource(
    local_path="configs/scratch/progs/matmul"
)
